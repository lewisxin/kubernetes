...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ContainerStatePaused) DeepCopyInto(out *ContainerStatePaused) {
	*out = *in
	in.PausedAt.DeepCopyInto(&out.PausedAt)
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ContainerStatePaused.
func (in *ContainerStatePaused) DeepCopy() *ContainerStatePaused {
	if in == nil {
		return nil
	}
	out := new(ContainerStatePaused)
