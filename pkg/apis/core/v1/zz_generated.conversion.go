...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*v1.ContainerStatePaused)(nil), (*core.ContainerStatePaused)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1_ContainerStatePaused_To_core_ContainerStatePaused(a.(*v1.ContainerStatePaused), b.(*core.ContainerStatePaused), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*core.ContainerStatePaused)(nil), (*v1.ContainerStatePaused)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_core_ContainerStatePaused_To_v1_ContainerStatePaused(a.(*core.ContainerStatePaused), b.(*v1.ContainerStatePaused), scope)
	}); err != nil {
		return err
	}
...
func autoConvert_v1_ContainerState_To_core_ContainerState(in *v1.ContainerState, out *core.ContainerState, s conversion.Scope) error {
	...
	out.Paused = (*core.ContainerStatePaused)(unsafe.Pointer(in.Paused))
	return nil
}
...
func autoConvert_core_ContainerState_To_v1_ContainerState(in *core.ContainerState, out *v1.ContainerState, s conversion.Scope) error {
	...
	out.Paused = (*v1.ContainerStatePaused)(unsafe.Pointer(in.Paused))
...
func autoConvert_v1_ContainerStatePaused_To_core_ContainerStatePaused(in *v1.ContainerStatePaused, out *core.ContainerStatePaused, s conversion.Scope) error {
	out.PausedAt = in.PausedAt
	return nil
}

// Convert_v1_ContainerStatePaused_To_core_ContainerStatePaused is an autogenerated conversion function.
func Convert_v1_ContainerStatePaused_To_core_ContainerStatePaused(in *v1.ContainerStatePaused, out *core.ContainerStatePaused, s conversion.Scope) error {
	return autoConvert_v1_ContainerStatePaused_To_core_ContainerStatePaused(in, out, s)
}

func autoConvert_core_ContainerStatePaused_To_v1_ContainerStatePaused(in *core.ContainerStatePaused, out *v1.ContainerStatePaused, s conversion.Scope) error {
	out.PausedAt = in.PausedAt
	return nil
}

// Convert_core_ContainerStatePaused_To_v1_ContainerStatePaused is an autogenerated conversion function.
func Convert_core_ContainerStatePaused_To_v1_ContainerStatePaused(in *core.ContainerStatePaused, out *v1.ContainerStatePaused, s conversion.Scope) error {
	return autoConvert_core_ContainerStatePaused_To_v1_ContainerStatePaused(in, out, s)
}
